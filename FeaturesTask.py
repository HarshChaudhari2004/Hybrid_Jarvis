...
def GoogleSearch(term):
    ...
    oooooo = open('I:\\jarvis\\How To Make Jarvis\\Data.txt','a')
    ...
    os.startfile('I:\\jarvis\\How To Make Jarvis\\DataBase\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    TimeHere=  open('I:\\jarvis\\How To Make Jarvis\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("I:\\jarvis\\How To Make Jarvis\\DataBase\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    def Download(link):
        ...
        video.download('I:\\jarvis\\How To Make Jarvis\\DataBase\\youtube')
    ...
    os.startfile('I:\\jarvis\\How To Make Jarvis\\DataBase\\youtube')

def SpeedTest():

    os.startfile("I:\\jarvis\\How To Make Jarvis\\DataBase\\Gui Programs\\SpeedTestGui.py")
